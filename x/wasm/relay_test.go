...
import (
	...
	chtd "github.com/ChronicNetwork/chtd/app"
	"github.com/ChronicNetwork/chtd/x/wasm/ibctesting"
	wasmkeeper "github.com/ChronicNetwork/chtd/x/wasm/keeper"
	wasmtesting "github.com/ChronicNetwork/chtd/x/wasm/keeper/wasmtesting"
	"github.com/ChronicNetwork/chtd/x/wasm/types"
)
...
func TestFromIBCTransferToContract(t *testing.T) {
	...
	originalBalance := chtd.NewTestSupport(t, chainA.App).BankKeeper().GetBalance(chainA.GetContext(), chainA.SenderAccount.GetAddress(), sdk.DefaultBondDenom)
	...
	// then
	newBalance := chtd.NewTestSupport(t, chainA.App).BankKeeper().GetBalance(chainA.GetContext(), chainA.SenderAccount.GetAddress(), sdk.DefaultBondDenom)
	...
	bankKeeperB := chtd.NewTestSupport(t, chainB.App).BankKeeper()
